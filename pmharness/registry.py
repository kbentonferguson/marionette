...
_PLAN_MODEL_OR_ALIASES = {
    ...
    "cursor-grok-4.6-high": ("x-ai/grok-4.6", "x-ai/grok-4.5", "x-ai/grok-4"),
    "cursor-grok-4.6-high-fast": ("x-ai/grok-4.6", "x-ai/grok-4.5", "x-ai/grok-4"),
    "cursor-grok-4.6-medium": ("x-ai/grok-4.6", "x-ai/grok-4-fast", "x-ai/grok-4"),
    "cursor-grok-4.6-low": ("x-ai/grok-4.6", "x-ai/grok-4-fast", "x-ai/grok-4"),
    "cursor-grok-4.5-high": ("x-ai/grok-4.5", "x-ai/grok-4", "x-ai/grok-4-fast", "x-ai/grok-3"),
    "cursor-grok-4.5-high-fast": ("x-ai/grok-4.5", "x-ai/grok-4", "x-ai/grok-4-fast"),
    "cursor-grok-4.5-medium": ("x-ai/grok-4-fast", "x-ai/grok-4.5", "x-ai/grok-4", "x-ai/grok-3"),
